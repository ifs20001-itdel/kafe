...
return (
    <main>
        ...
        <div className="text-gray-600 body-font">
            ...
            <p className="mt-8 leading-relaxed">Kefi Coffe And Space merupakan sebuah tempat makan yang berada di Medan. Rumah makan ini menyajikan berbagai menu minuman & aneka nasi yang dibanderol dengan harga yang murah dan bersahabat dengan kantong Anda.</p>
            </div>
        </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#minuman" data-bs-slide="next">
    ...
    <div class="container px-5 py-24 mx-auto">
        <div class="text-center mb-10">
        <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4">Promo</h1>
        <div class="flex mt-6 justify-center">
            <div class="w-16 h-1 rounded-full bg-yellow-500 inline-flex"></div>
        </div>
        </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#promo" data-bs-slide="next">
    ...
    <div className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <Button style={{ backgroundColor: "#DDCCAE", color: "#67442E" }} onClick={openMaps}>
            Open Maps
          </Button>
        </div>
      </div>
