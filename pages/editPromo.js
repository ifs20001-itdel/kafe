                    ...
                    <div>
                      <div>
                        <Link style={{
                          textDecoration: "none",
                          color: "#000"
                        }} href={`/${promo._id}/promos`}>
                          <img src={promo.image} alt="image description" style={{
                            width: "150.135px",
                            height: "150.135px",
                            borderRadius: "20px"
                          }} />
                      ...
                      <div className="mt-2 mb-6 text-left">
                        ...
                        <div className="bg-transparent" onClick={() => handleDelete(promo._id)}>
